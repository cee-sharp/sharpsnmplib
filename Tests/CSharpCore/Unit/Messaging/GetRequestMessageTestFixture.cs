...
public class GetRequestMessageTestFixture
{
    ...
    public void Test()
    {
        ...
        ISnmpMessage message = MessageFactory.ParseMessages(expected, new UserRegistry(), false)[0];
    ...
    public void TestConstructorV3Auth1()
    {
        ...
        IPrivacyProvider privacy =
            new DefaultPrivacyProvider(new MD5AuthenticationProvider(new OctetString("testpass")));
